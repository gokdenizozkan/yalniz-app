...
var DateTimePicker = factory((_props, ref) => {
  ...
  const minTime = minDate ? (0, import_dayjs35.default)(minDate).format("HH:mm:ss") : null;
  const maxTime = maxDate ? (0, import_dayjs35.default)(maxDate).format("HH:mm:ss") : null;
