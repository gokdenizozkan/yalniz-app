...
const NumberInput = factory.factory((_props, ref) => {
  ...
  const controls = /* @__PURE__ */ React__default.default.createElement("div", { ...getStyles("controls") }, /* @__PURE__ */ React__default.default.createElement(
    ...
    /* @__PURE__ */ React__default.default.createElement(NumberInputChevron.NumberInputChevron, { direction: "up" })
    ...
    /* @__PURE__ */ React__default.default.createElement(NumberInputChevron.NumberInputChevron, { direction: "down" })
  ));
