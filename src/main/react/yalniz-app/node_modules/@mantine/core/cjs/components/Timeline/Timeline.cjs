...
const varsResolver = createVarsResolver.createVarsResolver(
  (theme, { bulletSize, lineWidth, radius, color, autoContrast }) => ({
    root: {
      ...
      "--tl-icon-color": getAutoContrastValue.getAutoContrastValue(autoContrast, theme) ? getContrastColor.getContrastColor({ color, theme }) : void 0
    }
  })
);
const Timeline = factory.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React__default.default.createElement(Timeline_context.TimelineProvider, { value: { getStyles } }, /* @__PURE__ */ React__default.default.createElement(Box.Box, { ...getStyles("root"), mod: [{ align }, mod], ref, ...others }, items));
});
